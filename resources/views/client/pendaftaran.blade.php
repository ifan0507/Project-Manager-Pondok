                                                ...
                                                <div class="col-md-4 ps-2">
                                                    <div class="input-group input-group-dynamic mb-4" id="div_prov">
                                                        ...
                                                        <select class="form-control" id="provinsi" name="provinsi"
                                                            ...
                                                            <option disabled selected class="form-label" value="">
                                                                Provinsi
                                                            </option>
                                                ...
                                                <div class="col-md-2 ps-2">
                                                    <div class="input-group input-group-dynamic mb-4">
                                                        <select class="form-control" id="desa" name="desa"
                                                            required onclick="pilKec(this)" style="font-size: 0.8rem;">
                                            ...
                                            <div class="row">
                                                ...
                                                <di class="col-md-6 ps-2">
                                                    <div class="input-group input-group-dynamic mb-4">
                                                        ...
                                                        <input class="form-control" aria-label="" name="asal_sekolah"
                                                            id="asal_sekolah" type="text" required>
                                                    </div>
                                                </di>
                                            </div>
                                            <div class="row">
